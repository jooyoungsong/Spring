...
public class BoardDao implements BoardDaoInter {
   ...
   public List<BoardDto> getPagingList(int start, int perpage) {
	...
	public int getCheckPass(int num, int pass) {
		...
		HashMap<String, Integer> map=new HashMap<String, Integer>();  //키값은 저장해서 넘기는 값이라 무조건 string 올 수 밖에 없다고 생각하면 된다. //값에 integer말고 2개 받을 거라 object로 받을 수 도 있다.
		map.put("num", num);
		map.put("pass", pass);
	...
	public void deleteReboard(int num) {
		...
		session.delete("deletePagingOfReboard", num);
	}
